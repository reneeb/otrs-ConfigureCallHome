...
sub PackageVerify {
    ...
    my $PackageVerifyInfo = {
        Description => "<br>Please note that issues that are caused by working with this package are not covered by OTRS service contracts.",
        Title       => 'This package is not certified by OTRS Group, which does not mean it is of inferior quality than products of the OTRS Group.',
    };
	# EO ConfigureCallHome-capeIT
